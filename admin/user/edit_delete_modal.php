...
<div class="modal fade" id="delete_<?php echo $row['id_usuario']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">	
            	<p class="text-center">¿Estas seguro en borrar el Usuario?</p>
				<h2 class="text-center"><?php echo $row['nombres'].' '.$row['apellidos']; ?></h2>
			</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"></span> Cancelar</button>
                <a href="delete.php?id_usuario=<?php echo $row['id_usuario']; ?>" class="btn btn-danger"><span class="fa fa-trash"></span> Si</a>
            </div>
